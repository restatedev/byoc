...
<style type="text/css">
    ...
    ${[...Array(maxTabs).keys()]
      ...
      .awsui_tabs
          ...
          .awsui_tabs-header-scroll-container
          .awsui_tabs-header-list
          .awsui_tabs-tab:nth-of-type(${i + 1})
          label
      `,
      )
      .join(",")} {
    ...
    ${[...Array(maxTabs).keys()]
      ...
      .awsui_tabs
          [type="radio"]:nth-of-type(${i + 1}):checked
          ~ .awsui_tabs-content-wrapper
          .awsui_tabs-content:nth-of-type(${i + 1})
      `,
      )
      .join(",")} {
      display: block;
    ...
    .ecs-horizontal-attachment-gap-xxxs {
      gap: var(--space-scaled-xxxs-y3lcfc, 2px);
    }
    .ecs-horizontal-attachment-gap-xxs {
      gap: var(--space-scaled-xxs-erb0ou, 4px);
    }
    .ecs-horizontal-attachment-gap-xs {
      gap: var(--space-scaled-xs-ycdazf, 8px);
    }
    .ecs-horizontal-attachment-gap-s {
      gap: var(--space-scaled-s-z0v7is, 12px);
    }
    .ecs-horizontal-attachment-gap-m {
      gap: var(--space-scaled-m-fbpbtw, 16px);
    }
    .ecs-horizontal-attachment-gap-l {
      gap: var(--space-scaled-l-coydx8, 20px);
    }
    .ecs-horizontal-attachment-gap-xl {
      gap: var(--space-scaled-xl-5xk2j7, 24px);
    }
    .ecs-horizontal-attachment-gap-xxl {
      gap: var(--space-scaled-xxl-4l9f8c, 32px);
    }
    .ecs-horizontal-attachment-gap-xxxl {
      gap: var(--space-scaled-xxxl-vt7t1z, 40px);
    }
...
<div class="awsui_child">
  ...
  return `
<div class="awsui_vertical awsui_vertical-${size}">
 ${items.join("\n")}
</div>`;
}
...
<div class="awsui_child">
  ...
  return `
<div class="awsui_horizontal awsui_horizontal-${size}">
 ${items.join("\n")}
</div>`;
}
...
<div class="awsui_content-wrapper ${border ? "awsui_border" : ""}">
  ...
  <div class="awsui_content">
    <div
        class="awsui_content-inner ${padding ? "awsui_with-paddings" : ""} awsui_with-header"
    >
      ${inner}
    </div>
  </div>
...
export function columns(...inner: string[]): string {
  ...
  const items = [
    `
<div class="awsui_item awsui_first-column">
${inner[0]}
</div>`,
    ...inner
      .slice(1)
...
<li role="presentation" class="awsui_tabs-tab">
  <label for="${name}${i}" class="awsui_tabs-tab-header-container awsui_tabs-tab-focusable">
...
export function horizontalAttachment(...inner: string[]): string {
  return `<div class="ecs-horizontal-attachment ecs-horizontal-attachment-gap-xs">
${inner.join("\n")}
</div>`;
}
...
export function refresh(
  ...
  return `<a class="awsui_button awsui_button-no-text">${REFRESH_ICON}</a>
